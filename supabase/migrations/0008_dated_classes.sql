-- ===========================================================================
-- Clases por fecha + recurrencia opcional
--
-- Cada hueco tiene una fecha (class_date). Si is_recurring = true, la clase se
-- repite cada semana ese mismo día de la semana a partir de esa fecha; si es
-- false, existe solo en esa fecha concreta (clase puntual).
--
-- Los huecos existentes (sin class_date) quedan como recurrentes «desde
-- siempre», así que el horario actual sigue funcionando igual.
-- ===========================================================================
...
-- book_class: valida puntual (fecha exacta) o recurrente (día de la semana
-- desde la fecha de inicio), además de la ventana de reserva para socios.
