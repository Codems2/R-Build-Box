...
// remitente ("Muay Thai Box") y la plantilla con estilos.
...
function body(title: string, text: string, cta: string, url: string): string {
  return card(`
...
function render(type: string, firstName: string, url: string): { subject: string; html: string } {
...
Deno.serve(async (req) => {
  ...
  const { subject, html } = render(email_action_type, firstName, url);
